...
namespace App\Common\Support\AliOSS;

use App\Common\Support\AliOSS\Util\OSSUtil;
use App\Common\Support\AliOSS\Util\OSS_Exception;
use App\Common\Support\AliOSS\Util\MimeTypes;
use App\Common\Support\AliOSS\Lib\RequestCore;
use App\Common\Support\AliOSS\Lib\ResponseCore;
use App\Common\Support\AliOSS\Lib\RequestCore_Exception;
...
//基础配置：OSS的地址以及用户访问的ID和KEY
define('OSS_ACCESS_ID', 'gv0jJrtW8nx3YzLb');
define('OSS_ACCESS_KEY', '');
define('OSS_ENDPOINT', 'static.huodonging.com');
